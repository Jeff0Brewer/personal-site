...
const Project = props => {
  ...
  const mainWidth = 1200; const cardHeight = mainWidth * 0.55; const headerHeight = 350; const contentRadius = 30
  const animTime = 0.4
  ...
  return (
    ...
    >
      <motion.button
        className='proj-header' style={{ cursor: focus ? 'auto' : 'pointer' }}
      ...
      >
        <div style={{ backgroundImage: `url(${props.coverImg})` }} />
        <motion.div
      ...
      <button
        className='proj-close' aria-label='close'
